...
export const Register = () => {
  ...
  const onSubmit = async (formData) => {
    ...
    // Como reaproveitamos o nome da função, podemos apenas adicionar a parte assíncrona dela. Colocando o Async na função onSubmit e await nas partes que ela aguarda uma resposta/promessa.
